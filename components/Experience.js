...
const Experience = () => {
  ...
  return (
    <div className="bg-white dark:bg-[#151515]">
      ...
      <div className="bg-[#f1f1f1] dark:bg-black h-full min-h-screen">
        <div className=" grid grid-cols-1 md:grid-cols-3 max-w-6xl mx-auto gap-y-10 gap-x-20  pt-20 min-h-min">
          ...
          <div className="col-span-1 md:col-span-2 place-self-center mt-10">
            <ExperienceDetails
